        ...
        >
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-2">
                {highlights.map((h, i) => (
                  <Reveal key={h.title} variant={fadeUpBlur} delay={0.25 + i * 0.08}>
                    <div className="flow-highlight rounded-sm border border-line bg-ink/40 p-5 backdrop-blur-sm">
          ...
          <div className="lg:[direction:ltr] lg:sticky lg:top-28 lg:self-start">
            <Reveal variant={fadeUpBlur} delay={0.1}>
              ...
              <motion.div
                className="flow-frame relative aspect-[3/4] overflow-hidden rounded-sm md:aspect-[4/5]"
